...
class OneSignalClient
{
	...
	{
		return $this->sendNotificationToUsers($message, array($userId), $url, $data, $buttons, $schedule);
	}

	public function sendNotificationToUsers($message, array $userId, $url = null, $data = null, $buttons = null, $schedule = null)
	{
		$contents = array(
			"en" => $message
		);
