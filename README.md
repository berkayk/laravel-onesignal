...
You can easily send a message to all registered users with the command
    ...
    OneSignal::getClients()['appName']->sendNotificationToAll("Some Message", $url, $data, $buttons,$schedule);
...
After storing a user's tokens in a table, you can simply send a message with
    ...
    OneSignal::getClients()['appName']->sendNotificationToUser("Some Message", $userId, $url, $data, $buttons,$schedule);
...
You can simply send a notification to a specific segment with
    ...
    OneSignal::getClients()['appName']->sendNotificationToSegment("Some Message", $segment, $url, $data, $buttons,$schedule);
...
You can send a custom message with 
    ...
    OneSignal::getClients()['appName']->sendNotificationCustom($parameters);
    
    ### Sending a Custom Notification
### Sending a async Custom Notification
You can send a async custom message with 

    OneSignal::getClients()['appName']->async()->sendNotificationCustom($parameters);
